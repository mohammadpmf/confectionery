        ...
        "APPS": [
            {
                ...
                "secret": os.getenv("LINKED_IN_CLIENT_SECRET"),
                "settings": {
...
ACCOUNT_SESSION_REMEMBER = (
    True  # تیک ریممبر می رو به صورت پیش فرض فعال میذاره و دیگه به کاربر هم نشون نمیده.
)
...
ZARINPAL_MERCHANT_ID = os.getenv("ZARINPAL_MERCHANT_ID_FAKE")
...
MY_REGISTERED_NUMBER_ON_GHASEDAK = os.getenv("MY_REGISTERED_NUMBER_ON_GHASEDAK")
MY_LINE_NUMBER_ON_GHASEDAK_1 = os.getenv("MY_LINE_NUMBER_ON_GHASEDAK_1")
MY_LINE_NUMBER_ON_GHASEDAK_2 = os.getenv("MY_LINE_NUMBER_ON_GHASEDAK_2")
MY_TEMPLATE_NAME_IN_GHASEDAK_ME_SITE = os.getenv("MY_TEMPLATE_NAME_IN_GHASEDAK_ME_SITE")
...
# برای جلوگیری از اتک روی سرور اشتراکی پیشنهاد میشه.
ALLOWED_IMAGE_EXTENSIONS = [".jpg", ".jpeg", ".png", ".webp"]
DATA_UPLOAD_MAX_MEMORY_SIZE = 5 * 1024 * 1024
FILE_UPLOAD_MAX_MEMORY_SIZE = 5 * 1024 * 1024
IMAGE_UPLOAD_MAX_MEMORY_SIZE = 5 * 1024 * 1024
